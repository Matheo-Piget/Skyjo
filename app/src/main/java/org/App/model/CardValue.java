...
/**
 * The {@code CardValue} enum represents the possible values of a card in the game.
 ...
 * </ul>
 * <p>
 * Each enum constant has an associated integer value that can be retrieved using the {@link #getValue()} method.
 * 
 * @see Card
 * 
 * @author Mathéo Piget
